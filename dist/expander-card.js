...
var wt = Array.isArray, bt = Array.from, Be = Object.keys, We = Object.defineProperty, ce = Object.getOwnPropertyDescriptor, Vr = Object.getOwnPropertyDescriptors, Ur = Object.prototype, Br = Array.prototype, ot = Object.getPrototypeOf;
function Wr(e) {
...
const J = 2, Bt = 4, Ze = 8, Qe = 16, W = 32, qe = 64, ve = 128, je = 256, F = 512, ae = 1024, Re = 2048, K = 4096, Ie = 8192, Wt = 16384, Me = 32768, Kr = 1 << 18, jt = 1 << 19, He = Symbol("$state"), Xr = Symbol("");
function Kt(e) {
  return e === this.v;
}
function zr(e, t) {
...
function un(e, t) {
  return e.equals(t) || (e.v = t, e.version = cr(), zt(e, ae), g !== null && g.f & F && !(g.f & W) && (A !== null && A.includes(e) ? (Z(g, ae), nt(g)) : ie === null ? $n([e]) : ie.push(e))), t;
}
function zt(e, t) {
  var r = e.reactions;
  if (r !== null)
...
function Zt(e) {
  var t = Jt(e), r = (pe || e.f & ve) && e.deps !== null ? Re : F;
  Z(e, r), e.equals(t) || (e.v = t, e.version = cr());
}
function Et(e) {
  Gt(e), Oe(e, 0), Z(e, Ie), e.v = e.children = e.deps = e.ctx = e.reactions = null;
}
function cn(e) {
...
function tt(e, t = 0) {
  return De(Ze | Qe | t, e, !0);
}
function me(e, t = !0) {
  return De(Ze | W, e, !0, t);
}
function rr(e) {
  var t = e.teardown;
  if (t !== null) {
...
function xt(e, t, r) {
  if (!(e.f & K)) {
    ...
    for (var n = e.first; n !== null; ) {
      var i = n.next, a = (n.f & Me) !== 0 || (n.f & W) !== 0;
      xt(n, t, a ? r : !1), n = i;
    }
  }
}
...
function lr(e, t) {
  if (e.f & K) {
    ...
    for (var r = e.first; r !== null; ) {
      var n = r.next, i = (r.f & Me) !== 0 || (r.f & W) !== 0;
      lr(r, i ? t : !1), r = n;
    }
...
function dr(e) {
  var d;
  var t = A, r = D, n = ie, i = T, a = pe, s = X, u = I, f = e.f;
  A = /** @type {null | Value[]} */
  null, D = 0, ie = null, T = f & (W | qe) ? null : e, pe = !$e && (f & ve) !== 0, X = null, I = e.ctx;
  try {
    var o = (
      /** @type {Function} */
      (0, e.fn)()
    ...
    if (A !== null) {
      var c;
      if (Oe(e, D), l !== null && D > 0)
        for (l.length = D + A.length, c = 0; c < A.length; c++)
          l[D + c] = A[c];
      else
        e.deps = l = A;
      if (!pe)
    ...
    } else l !== null && D < l.length && (Oe(e, D), l.length = D);
    return o;
  } finally {
    A = t, D = r, ie = n, T = i, pe = a, X = s, I = u;
  }
}
function wn(e, t) {
  let r = t.reactions;
  ...
  (A === null || !A.includes(t)) && (Z(t, Re), t.f & (ve | je) || (t.f ^= je), Oe(
    /** @type {Derived} **/
    t,
    0
  ));
...
function bn(e) {
  ...
  if (t !== 0)
    for (var r = 0; r < t; r++) {
      var n = e[r];
      !(n.f & (Ie | K)) && Le(n) && (rt(n), n.deps === null && n.first === null && n.nodes_start === null && (n.teardown === null ? ar(n) : n.fn = null));
    }
}
function kn() {
  if (Ae = !1, ye > 1001)
...
function nt(e) {
  Ye === ur && (Ae || (Ae = !0, queueMicrotask(kn)));
...
function m(e) {
  ...
  if (T !== null) {
    ...
    var i = T.deps;
    A === null && i !== null && i[D] === e ? D++ : A === null ? A = [e] : A.push(e), ie !== null && g !== null && g.f & F && !(g.f & W) && ie.includes(e) && (Z(g, ae), nt(g));
  ...
  return new Proxy(
    ...
    e,
    {
      defineProperty(f, o, l) {
        ...
        var c = i.get(o);
        return c === void 0 ? (c = Y(l.value), i.set(o, c)) : O(c, j(l.value, u)), !0;
      },
      deleteProperty(f, o) {
        var l = i.get(o);
        if (l === void 0)
      ...
      set(f, o, l, c) {
        ...
        if (a && o === "length")
          ...
          d.v; _ += 1) {
            var p = i.get(_ + "");
            p !== void 0 ? O(p, M) : _ in f && (p = Y(M), i.set(_ + "", p));
          }
        d === void 0 ? (!v || (w = ce(f, o)) != null && w.writable) && (d = Y(void 0), O(d, j(l, u)), i.set(o, d)) : (v = d.v !== M, O(d, j(l, u)));
        ...
        if (k != null && k.set && k.set.call(c, l), !v) {
          if (a && typeof o == "string") {
            ...
            Number.isInteger(E) && E >= h.v && O(h, E + 1);
          }
          Mt(s);
        }
        return !0;
  ...
  var u = /* @__PURE__ */ new Set(), f = (c) => {
    for (var d = 0; d < c.length; d++) {
      ...
      if (!u.has(v)) {
        ...
        var p = he.get(v);
        p === void 0 ? (document.addEventListener(v, Fe, { passive: _ }), he.set(v, 1)) : he.set(v, p + 1);
      }
    }
  };
  f(bt(yr)), dt.add(f);
  var o = void 0, l = er(() => {
    ...
    return me(() => {
      ...
      for (var d of u) {
        ...
        --v === 0 ? (document.removeEventListener(d, Fe), he.delete(d)) : he.set(d, v);
      }
...
function _t(e, t, r, n = null, i = !1) {
  ...
  tt(() => {
    ...
    f ? (s ? Se(s) : s = me(() => r(a)), u && Xe(u, () => {
      u = null;
    })) : (u ? Se(u) : n && (u = me(() => n(a))), s && Xe(s, () => {
      s = null;
    })), l && B(!0);
  }, o), x && (a = C);
}
...
function Rn(e, t, r, n, i, a = null) {
  ...
  tt(() => {
    ...
    a !== null && (v === 0 ? o ? Se(o) : o = me(() => a(s)) : o !== null && Xe(o, () => {
      o = null;
    })), _ && B(!0), r();
  }), x && (s = C);
}
...
function Tr(e, t, r, n) {
  ...
  var c = {
    is_global: i,
    in() {
      t.inert = u, Pe(t, "introstart"), f = ht(t, l(), o, 1, () => {
        Pe(t, "introend"), f == null || f.abort(), f = s = void 0;
      });
    },
    out(p) {
      t.inert = !0, Pe(t, "outrostart"), o = ht(t, l(), f, 0, () => {
        Pe(t, "outroend"), p == null || p();
      });
    },
    stop: () => {
...
function Vn(e) {
  for (var t = g, r = g; t !== null && !(t.f & (W | qe)); )
    t = t.parent;
  try {
    return V(t), e();
  } finally {
...
function ge(e, t, r, n) {
  ...
  return function(w, N) {
    if (arguments.length > 0) {
      const S = N ? m(h) : w;
      return h.equals(S) || (_ = !0, O(k, S), l && f !== void 0 && (f = S), it(() => m(h))), w;
    }
    return m(h);
  };
}
  ...
  constructor(t) {
    ...
    const i = new Proxy(
      { ...t.props || {}, $$events: {} },
      {
        ...
        set(s, u, f) {
          return O(r.get(u) ?? n(u, f), f), Reflect.set(s, u, f);
        }
      }
    );
  ...
  async connectedCallback() {
    if (this.$$cn = !0, !this.$$c) {
      ...
      for (const i of this.attributes) {
        ...
        a in this.$$d || (this.$$d[a] = Ue(a, i.value, this.$$p_d, "toProp"));
      }
...
let Je = Ke(void 0);
const jn = async () => (O(Je, j(await window.loadCardHelpers().then((e) => e))), m(Je)), Kn = () => m(Je) ? m(Je) : jn();
function Xn(e) {
  const t = e - 1;
  return t * t * t + 1;
}
...
function pt(e, t) {
  ...
  Qt(() => {
    ...
    d.hass = i(), m(s) && (m(s).replaceWith(d), O(s, j(d)), O(u, !1));
  });
  var f = Gn(), o = le(f);
  Mn(o, r, !1, (c, d) => {
    Yn(c, (v) => O(s, j(v)), () => m(s)), Te(c, "svelte-1sdlsm"), Tr(3, c, () => Ar);
  });
  var l = Ve(o, 2);
  return _t(l, () => m(u), (c) => {
    var d = zn();
...
function ii(e, t) {
  ...
  Cr(() => {
    ...
    if ($ && b ? n().expanded = y >= $ && y <= b : $ ? n().expanded = y >= $ : b && (n().expanded = y <= b), s !== void 0)
      try {
        ...
        q === null ? n().expanded !== void 0 && o(n().expanded) : O(a, j(q ? q === "true" : m(a)));
      } catch (q) {
        console.error(q);
      }
    else
  ...
  const l = ($) => {
    if (i)
      return $.preventDefault(), $.stopImmediatePropagation(), i = !1, !1;
    f();
  }, c = ($) => {
  ...
  const k = ($) => {
    ...
    !v && d === $.target && n()["title-card-clickable"] && f(), d = void 0, i = !0, setTimeout(() => i = !1, 300);
  };
  var w = ri(), N = le(w);
  _t(
    N,
  ...
  return _t(S, () => n().cards && m(a), ($) => {
    ...
    }), ee(b), xe(() => oe(b, "style", `--expander-card-display:${n()["expander-card-display"] ?? ""};
             --gap:${(m(a) ? n()["expanded-gap"] : n().gap) ?? ""}; --child-padding:${n()["child-padding"] ?? ""}`)), Tr(3, b, () => Ar, () => ({ duration: 300, easing: Zn })), fe($, b);
  }), ee(w), xe(() => {
